...
//
// MU_CHANGE: Pre-allocate page table memory from a reserved low-memory pool
// so that mapping large regions (Upper DDR) does not allocate page table
// pages from within the still-unmapped region.
//
VOID *
